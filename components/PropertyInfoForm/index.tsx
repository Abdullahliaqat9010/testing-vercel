					...
					<Form>
						...
						<div className="d-flex flex-row justify-content-between pt-1">
							...
							>
								...
								<FieldWithPostTab name="live_area" type="number" tabText="m²" />
								<ErrorMessage
									className="form-error"
									component="div"
									name="live_area"
						...
						<PicturesWall
							setImages={(images) =>
								setFieldValue("images", [
									...images.map(({ response, url }) => (url ? url : response)),
								])
							}
						...
						<div className="mt-5 d-md-flex flex-md-row">
							...
							<Button className="form-back-button w-md-49" block type="submit">
								Save as draft
							</Button>
						</div>
					</Form>
