		...
		<div className="info-block container">
			<div className="info-block__top d-flex justify-content-between">
				...
				<div className="right-block">
					<div className="image-block d-flex">
						<div className="d-lg-none d-flex flex-row justify-content-between w-100">
							<img
								className="first-image-mobile"
								src={FirstImageMobile}
								alt="FirstImageMobile"
							/>
							<img
								className="second-image-mobile mt-n3"
								src={SecondImageMobile}
								alt="SecondImageMobile"
							/>
							<img
								className="third-image-mobile"
								src={ThirdImageMobile}
								alt="ThirdImageMobile"
							/>
						</div>
						...
						<div className="d-none d-lg-flex">
							...
							<div className="image-block__right">
								<div className="top">
									<img
										className="mr-16px second-image"
										src={SecondImage}
										alt="SecondImage"
									/>
									<img
								...
								<div className="bottom">
									<img
										className="mr-16px fourth-image"
										src={FourthImage}
										alt="FourthImage"
									/>
									<img
			...
			<div className="info-block__middle d-flex justify-content-between">
				<div className="left-block w-55">
					<img
						className="map-image"
						src={isMobile ? MapImageMobile : MapImage}
						alt="MapImage"
					/>
				</div>
				<div className="right-block">
					<h2 className="title-h2">{t("title.bottom-block")}</h2>
					<p>{t("desc.bottom-block")}</p>
					<Button className="get-estimation" onClick={scrollToTop}>
						{t("button.get-free-estimation")}
					</Button>
				</div>
