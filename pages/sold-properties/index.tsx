                    ...
                    <div className="controler-block ">
                        <div className=" title-button-block justify-content-between d-flex">
                            ...
                            <div className="bottons" >
                                <Button className="import-button" >
                                    <img src={Upload} alt="AddIcon" /><span className="import-bt-text">Import</span>
                                </Button>
                                <Button >
                                    <img src={AddIcon} alt="AddIcon" /><span className="add-bt-text">Add</span>
                                </Button>
                            </div>
                        </div>
                        <div className="w-100 py-4 whole-selecter-block justify-content-between d-flex">
                            ...
                            <div className="action-block">
                                ...
                                <span className="ml-1" > <img src={Delete} alt="eye" /></span>
                            </div>
                        </div>
                                ...
                                <div className="w-100 property-container d-flex" key={index}>
                                    ...
                                    <div className=" property-discription  d-flex" >
                                        <div className="proprty-info">
                                            <div><span className='address'>ja aksdha akjsdhaks askjdhaksj</span></div>
                                            <div><span className="sold-property" >sold date </span></div>
                                            <div className=" property-props mt-2 d-flex" >
                                                <span className="mr-1">{property.total_area + " " + 'sq m'}</span>
                                                <span className="mx-1">{property.bedrooms + " " + t('span.beds')}</span>
                                                <span className="mx-1">{property.bathrooms + " " + t('span.baths')}</span>
                                            </div>
                                        </div>
                                        <div className=" d-flex view-property" > <span> <img src={blackeye} alt="eye" /></span></div>
                                    </div>

                                </div>
                        )}
                        <div className="load-more-block d-flex ">
                            <Button className="load-more"> <img src={loadMoreImage} alt="loadMore" /> load more</Button>
                        </div>
                    </div>
