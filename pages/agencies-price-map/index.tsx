...
const priceMap = () => {
  const { t, i18n } = useTranslation("price-map");
      ...
      inputLength === 0
        ...
        : citydata.filter(
            (city) =>
              ...
              city.zipcode.toLowerCase().slice(0, inputLength) === inputValue
          );
    setCity(fitertUser);
  }, [textToSearch]);
      ...
      <div className=" price-map-main">
        <div className="search-area d-flex my-3 ">
          <input
            type="search"
            value={textToSearch}
            onChange={(el) => filterCities(el.target.value)}
            placeholder={t("pricemap.placeholder")}
          />
          <ListGroup
            as="ul"
            id="navbar-example2"
              ...
              updatesearch.map((cityData, index) => {
                return (
                  <ListGroup.Item
                    ...
                    onClick={() => onSuggesstionClick(index)}
                  >
                    <a className="text-dark" href={"#" + cityData.name}>
                      {cityData.name} {cityData.zipcode}
                    </a>
                  </ListGroup.Item>
                );
              })}
          ...
          <CustomScrollbar>
                  ...
                  <div className="city-price-content-map">
                    ...
                    <div className=" city-price-date d-flex ">
                      <div className="d-flex justify-content-center main-block">
                        <div className="text-center home-type">
                          <div>
                            <img
                              src={ApartmentImageNoActive}
                              alt="ApartmentImageNoActive"
                            />
                            <br></br>
                            <span>{t("pricemap.appartment")}</span>
                          </div>
                        </div>
                    ...
                    <div className="estimate-links-block text-center d-flex flex-column">
                      ...
                      <div className="links-block get-prices">
                        {/* <p>
                          Ou obtenez les prix de vente des blens a proximite
                        </p> */}
            ...
            {!cityPriceMap && (
              <div className="city-price-block">
                <p>{t("p.city-price-block")}</p>

                <Table cellSpacing="0" cellPadding="1" width="300">
                  <thead>
                    <tr>
                      <th> {t("pricemap.ville")}</th>
                      <th>{t("pricemap.city-block-appartment")}</th>
                      <th>{t("pricemap.maison")}</th>
                    </tr>
                  </thead>
                  <tbody
                    data-bs-spy="scroll"
...
export const getServerSideProps = async ({ locale }) => {
  return {
    props: {
      ...(await serverSideTranslations(locale, ["header", "footer","price-map"])),
    },
  };
};
