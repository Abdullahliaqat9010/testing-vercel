		...
		<>
			...
			<div className="Terms">
				...
				<div className="main-content">
					<h4>
						{t("h4.title")} <span>{t("span.company-name")}</span>
					</h4>
					...
					<div className="double-block">
						...
						<div className="double-block__text">
							<span>{t("span.checpter-three")}</span>
							<ul>
								<li>{t("checpter-three-li1")}</li>
								<li>{t("checpter-three-li2")}</li>
								<li className="mb-0">{t("checpter-three-li3")}</li>
							</ul>
						</div>
					</div>
					<div className="double-block">
						<span className="double-block__label">3.2</span>
						<span className="double-block__text">{t("checpter-three.2")}</span>
					</div>
					<div className="double-block">
						<span className="double-block__label">3.3</span>
						<span className="double-block__text">{t("checpter-three.3")}</span>
					</div>
					{/*SECTION 4*/}
					<div className="new-segment">
					...
					<div className="double-block">
						...
						<span className="double-block__text">{t("chepter-four")}</span>
					</div>
					<div className="double-block">
						<span className="double-block__label">4.2</span>
						<div className="double-block__text">
							<p>{t("chapter-four.2-p1")}</p>
							<p>{t("chapter-four.2-p2")}</p>
							<p className="mb-0">{t("chapter-four.2-p3")}</p>
						</div>
					</div>
					<div className="double-block">
						<span className="double-block__label">4.3</span>
						<span className="double-block__text">{t("chapter-four.3-p1")}</span>
					</div>
					<div className="double-block">
					...
					<div className="double-block">
						...
						<div className="double-block__text">
							<p>
								{t("chepter-four.5-p1")}{" "}
								<a href="mailto:support@winleads.eu">support@winleads.eu</a>.
							</p>
							<p>{t("chepter-four.5-p2")}</p>
						</div>
					</div>
					<div className="double-block">
						<span className="double-block__label">4.6</span>
						<span className="double-block__text">{t("chepter-four.6")}</span>
					</div>
					{/*SECTION 5*/}
					<div className="new-segment">
					...
					<div className="double-block">
						...
						<div className="double-block__text">
							<p>{t("chepter-five.1-p1")}</p>
							<p>{t("chepter-five.1-p2")}</p>
						</div>
					</div>
					<div className="double-block">
					...
					<div className="double-block">
						...
						<div className="double-block__text">
							<span>{t("chepter-five.3-span")}</span>
							<ul className="roman-items">
								<li className="first">{t("chepter-five.3-li1")}</li>
								<li className="second">{t("chepter-five.3-li2")}</li>
								<li className="third">{t("chepter-five.3-li3")}</li>
							</ul>
						</div>
					</div>
					<div className="double-block">
					...
					<div className="double-block">
						...
						<div className="double-block__text">
							<span>{t("chepter-seven.1-span")}</span>
							<ul className="roman-items">
								<li className="first">
									{/* <b>{t("chepter-seven.1-li1.b")}</b>  */}
									{t("chepter-seven.1-li1")}
								</li>
								<li className="second">{t("chepter-seven.1-li2")}</li>
								<li className="third">
					...
					<div className="double-block">
						...
						<div className="double-block__text">
							<span>{t("chepter-seven.3-span")}</span>
							<ul className="roman-items">
								<li className="first">{t("chepter-seven.3-li1")}</li>
								<li className="second">{t("chepter-seven.3-li2")}</li>
								<li className="third">{t("chepter-seven.3-li3")}</li>
								<li className="fourth">{t("chepter-seven.3-li4")}</li>
							</ul>
							<p>{t("chepter-seven.3-p")}</p>
						</div>
					</div>
					{/*SECTION 8*/}
					<div className="new-segment">
					...
					<p>{t("chepter-eight-p1")}</p>
					<p>{t("chepter-eight-p2")}</p>
					{/*SECTION 9*/}
					<div className="new-segment">
					...
					<div className="double-block">
						...
						<div className="double-block__text">
							<span>{t("chepter-nine.3-span")}</span>
							<p className="mt-3">{t("chepter-nine.3-p")}</p>
							<ul className="roman-items">
								<li className="first">{t("chepter-nine.3-li1")}</li>
								<li className="second">{t("chepter-nine.3-li2")}</li>
							</ul>
							<p>{t("chepter-nine.3-p2")}</p>
							<p>{t("chepter-nine.3-p3")}</p>
						</div>
					</div>
					<div className="double-block">
					...
					<div className="double-block">
						...
						<span className="double-block__text">{t("chepter-tweleve.1")}</span>
					</div>
					<div className="double-block">
						<span className="double-block__label">12.2</span>
						<span className="double-block__text">{t("chepter-tweleve.2")}</span>
					</div>
					{/*SECTION 13*/}
					<div className="new-segment">
					...
					<div className="double-block">
						...
						<div className="double-block__text">
							<p>{t("chepter-thirteen.2-p1")}</p>
							<p>{t("chepter-thirteen.2-p2")}</p>
						</div>
					</div>
					{/*SECTION 14*/}
					<div className="new-segment">
					...
					<div className="double-block">
						...
						<span className="double-block__text">
							{t("chepter-fourteen.3.part1")}{" "}
							<a href="mailto:matteo@winleads.eu">matteo@winleads.eu</a>
							{t("chepter-fourteen.3.part2")}
						</span>
					</div>
				</div>
			</div>
