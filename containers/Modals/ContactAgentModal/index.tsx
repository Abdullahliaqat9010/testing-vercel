...
import {
	closeModalWindowContactAgentAction,
	contactAgencyAction,
} from "../../../actions";
...
const ContactAgentModal = () => {
	...
	const { showAgentModal, showSuccessModal } = useSelector(
				...
				<>
					<Modal.Header closeButton>
						<Modal.Title className="d-flex flex-column">
							{t("button.contact")}{" "}
							{agencyContactInfo.agentName +
								" " +
								agencyContactInfo.agentSurname}
				...
				<>
					...
					<Modal.Body>
						<div className="main-content">
							...
							<p>
								<span>
									{t("desc.agency")} {agencyContactInfo.title} {t("desc.soon")}
								</span>
							</p>
