...
const portFolio = ({ agency, comments }) => {
	...
	useEffect(() => {
		let linksArray = agency?.social_links
			? agency?.social_links?.split(",")
			: [];
					...
					<div>
						...
						<ContentBlock className="d-flex  ">
							<MainDiv>
								<ProfileContainer>
									<div className=" d-flex border-bottom border-bottom-gray pb-3 ">
										...
										<div className="d-flex flex-column justify-content-center pl-3">
											...
											<span className="my-2">
												{"With Immo Belgium since"} {date.getFullYear()}
											</span>
										</div>
									</div>
									<div className="border-bottom border-bottom-gray pb-3">
										...
										<div className="d-flex my-2">
											...
											>
												{!showContact ? "Show Phone" : "+32273892712"}
											</Labels>
										</div>
										<div className="d-flex my-2">
											<BasicInfoLabes>
								...
								>
									<Headlines>{"leave a comment"}</Headlines>
